//Copyright 2003-2013 VisiStat, Inc., All Rights Reserved.
...
function msrec(e) {
	...
	msxy.src= 'https:\/\/sniff.visistat.com\/tm.php?r='+rand+'&DID='+DID+'&pw='+pw+'&ph='+ph+'&msx='+msx+'&msy='+msy+'&mspage='+window.location.pathname.substring(window.location.pathname.lastIndexOf('\\') + 1) + window.location.search;
}
